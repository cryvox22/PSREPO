...
#Documentation: https://www.mioso.com/blog/microsoft-windows/windows-server/automatischer-neustart-nach-updates-deaktivieren-windows-server-2016/
    Write-Host -ForegroundColor Cyan "Die Aufgabe für den automatischen Reboot wird deaktiviert..."
    ...
    Write-Host -ForegroundColor Green "Der automatische Server-Reboot wurde für $LocalHostname deaktiviert!"
